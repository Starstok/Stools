...
XVERSION=$(grep -m 1 "^version=" system/xposed.prop | dd bs=1 skip=8)
XARCH=$(grep -m 1 "^arch=" system/xposed.prop | dd bs=1 skip=5)
XMINSDK=$(grep -m 1 "^minsdk=" system/xposed.prop | dd bs=1 skip=7)
XMAXSDK=$(grep -m 1 "^maxsdk=" system/xposed.prop | dd bs=1 skip=7)
